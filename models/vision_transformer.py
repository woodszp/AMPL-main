...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=[224], patch_size=16, in_chans=3, num_classes=0, embed_dim=768, depth=12,
        ...
        # Meta prompt 
        # self.prompt_token = MetaLearner(channels=embed_dim)
        # self.prompt_token = nn.Parameter(torch.zeros(1, 96, embed_dim))
        ...
        # Meta prompt 
        # trunc_normal_(self.prompt_token, std=.02)
    ...
    def prepare_tokens(self, x, mask=None):
        ...
        x = self.patch_embed(x)  # [90, 384,14,14]
        ...
        # Meta Prompt
        # prompt_tokens = self.prompt_token(x)
        ...
        # Meta prompt
        # x = torch.cat((prompt_tokens, x), dim=1) # [256, 228, 384]
