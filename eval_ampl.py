...
server_dict = {
    'mini':{
        ...
        'data_path': '/home/xxx/Data/miniImageNet/'
        },  
    'fs':{
        'dataset': 'fs',
        'dataset_name': 'cifar-fs',
        'data_path': '/home/xxx/Data/cifarfs/'
        },
    'fc100':{
        'dataset': 'fc100',
        'dataset_name': 'FC100',
        'data_path': '/home/xxx/Data/FC100/'
        },
    'tiered':{
        'dataset': 'tiered',
        'dataset_name': 'tiered-imagenet',
        'data_path': '/home/xxx/Data/tiered_imagenet/'
        },
}
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('Evaluation AMPL')
